...
export function connectorIsStale(lastSeen:string|null,seconds=120,now=Date.now()){return !lastSeen||!Number.isFinite(Date.parse(lastSeen))||now-Date.parse(lastSeen)>seconds*1000}
